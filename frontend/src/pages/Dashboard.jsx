...
const Dashboard = () => {
  ...
  return (
    <DashboardLayout>
        <div className={styles.container}>
            ...
            {!loading && allResumes.length ===0 && (
                <div className={styles.emptyStateWrapper}>
                    ...
                    <h3 className={styles.emptyTitle}>No Resymes Yet</h3>
            ...
            {!loading && allResumes.length>0 &&(
                <div className={styles.grid}>
                    ...
                    {allResumes.map((resume)=>(
                        <ResumeSummaryCard
                            key={resume._id} imgUrl={resume.thumbnailLink}
        ...
        showActionBtn actionBtnText='Delete' actionBtnClassName='bg-red-600 hover:bg-read-700'

...
import Modal from '../components/Modal' // <-- REQUIRED IMPORT
import Login from '../components/Login' // <-- REQUIRED IMPORT
                ...
                <div className={landingPageStyles.heroGrid}>
                    ...
                    <div className={landingPageStyles.heroLeft}>
                        ...
                        <p className={landingPageStyles.description}>
                            ...
                            ATS-friendly, recruiter-aproved, and tailored to your career goals
                        </p>
                        ...
                        {[
                                ...
                                <div key={index} className={landingPageStyles.featureCard}>
                                    ...
                                    <div className={'${landingPageStyles.featureCardContent} ${feature.bg}'}>
                                        ...
                                        <h3 className={landingPageStyles.featureTitile}>
                                            {feature.title}
                                        </h3>
        ...
        <footer className={landingPageStyles.footer}>
            <div className={landingPageStyles.footerContainer}>
                <p className={landingPageStyles.footerText}>
                     ...
                     <a href="https://narasinghsportfolio.netlify.app/" target="_blank" className="landingPageStyles footerLink">
                      BrawlyNara
                     </a>
                </p>
            </div>

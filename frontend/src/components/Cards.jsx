...
export const TemplateCard=({thumbnailImg, isSelected, onSelect})=>{
  return (
    ...
    cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-lh rounded-3xl
...

        {
          thumbnailImg ? (
            <div className="relative w-full h-full overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-white/60 via-transparent to-transport opacity-0    group-hover:opacity-100 transition-opacity duration-300"/>
                {
                  isSelected && (
                    <div className="absolute inset-0 bg-violet-500/10 flex items-center justify-center">
                      <div className="w-16 h-16 bg-white backdrop-blur-sm rounded-full flex items-center justify-center shadow-lg animeate-pulse">
